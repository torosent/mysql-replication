...
az vm availability-set create --resource-group $resourceGroupName --location $resourceGroupLocation --name mySqlAvailabilitySet --platform-update-domain-count 5 --platform-fault-domain-count 3
